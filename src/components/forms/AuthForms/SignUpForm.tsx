  ...
  return (
    <div className={classes.signUp}>
      ...
      >
        ...
        <Form.Item
          name="phone"
          rules={[{ required: true, message: "Укажите номер телефона в формате +996*********!" }]}
        >
        ...
        <Form.Item>
          <Checkbox onChange={(e: any)=>setAgreement(e.target.checked)} >Пользовательское соглашение</Checkbox>
        </Form.Item>
